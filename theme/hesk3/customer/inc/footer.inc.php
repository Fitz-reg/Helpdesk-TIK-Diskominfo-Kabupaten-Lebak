...
*******************************************************************************/
?>
<footer class="dkt-footer">
    <div class="dkt-footer-grid">
        <div class="dkt-footer-col">
            <h4>Diskominfo Kab. Lebak</h4>
            <p>Dinas Komunikasi, Informatika, Statistik dan Persandian Pemerintah Kabupaten Lebak. Melayani dukungan TIK terintegrasi untuk Seluruh Perangkat Daerah, Pegawai, dan Masyarakat Kabupaten Lebak.</p>
            <p><strong>Alamat:</strong> Jl. Abdi Negara No. 3 Rangkasbitung, Kabupaten Lebak, Banten.</p>
        </div>
        <div class="dkt-footer-col">
            <h4>Layanan Utama TIK</h4>
            <ul class="dkt-footer-links">
                <li><a href="index.php?a=add">Pengajuan Tiket Bantuan TIK</a></li>
                <li><a href="ticket.php">Cek & Lacak Tiket Layanan</a></li>
                <li><a href="knowledgebase.php">Panduan Aplikasi & E-Gov</a></li>
                <li><a href="https://lebakkab.go.id" target="_blank">Portal Resmi Kabupaten Lebak</a></li>
            </ul>
        </div>
        <div class="dkt-footer-col">
            <h4>Pusat Kontak & Bantuan</h4>
            <p><strong>Email Helpdesk:</strong> diskominfo@lebakkab.go.id</p>
            <p><strong>Jam Operasional:</strong><br>Senin - Jumat: 08:00 - 16:00 WIB</p>
        </div>
    </div>
    <div class="dkt-footer-bottom">
        <div>&copy; <?php echo date('Y'); ?> Dinas Komunikasi, Informatika, Statistik dan Persandian Kabupaten Lebak. Hak Cipta Dilindungi.</div>
        <div>Layanan Helpdesk TIK Berbasis HESK</div>
    </div>
</footer>
</main>  <!-- End main -->
        </div> <!-- End wrapper -->
