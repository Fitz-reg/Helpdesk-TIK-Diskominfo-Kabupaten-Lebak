<?php
/**
 * Configuration Settings for HESK 3.7.11
 * Diskominfo Kabupaten Lebak Helpdesk System
 */
...
$hesk_settings['language']         = 'Indonesian';
$hesk_settings['languages']        = array(
    'Indonesian' => array('folder' => 'id', 'hr' => '------ Balas di atas baris ini ------'),
...
// =========================================================================
// 2. HELPDESK & TICKET SYSTEM FEATURES
// =========================================================================
...
// =========================================================================
$hesk_settings['customer_accounts']                      = 1; // 1 = Enabled
$hesk_settings['customer_accounts_required']             = 1; // 1 = Login required for submitting tickets
$hesk_settings['customer_accounts_customer_self_register']= 1; // 1 = Self-registration allowed
$hesk_settings['customer_accounts_admin_approvals']       = 0; // 0 = Instant approval
$hesk_settings['customer_autologin']                     = 1;
$hesk_settings['customer_accounts_allow_email_changes']   = 1;
$hesk_settings['customer_accounts_verify_email']          = 0; // 0 = Instant verification
$hesk_settings['customer_accounts_verify_email_cooldown'] = 5;

// =========================================================================
// 4. SPAM PREVENTION & SECURITY
// =========================================================================
$hesk_settings['secimg_use']             = 1; // 1 = Security Image CAPTCHA required for ticket submission
...
$hesk_settings['question_ask']           = 'What color is grass?';
...
// =========================================================================
// 10. LOOK & FEEL THEME OVERRIDES
// =========================================================================
$hesk_settings['customer_theme']         = '';
$hesk_settings['theme_overrides']        = array();

// SYSTEM ENGINE LOGIC - DO NOT MODIFY BELOW
$hesk_settings['hesk_version']           = '3.7.11';
